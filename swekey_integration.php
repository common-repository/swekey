...
class SwekeyIntegration
{
	...
	function GetIntegrationScript()
	{
	    ...
	    if (empty($this->set_cookie_url))
 	          $this->set_cookie_url = $this->swekey_dir_url . "set_cookie.html";
		...
		{
	        $js .= "Swekey_EnableMobileEmulation('" . $this->set_cookie_url . "', $force_swekey_emulation_update);\n";
		}
...
<?php
		...
		$output .= "<!-- WordPress 2.0.1.5461 01/20/14 (emulation:$emul)-->\n";
